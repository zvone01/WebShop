...
try {
    ...
    //Recipients
    $mail->setFrom($configs->email->adress, 'Fondue Chalet Baden');
    ...
    $r1receipt ="";
    if($data->MailData->R1Receipt == "True") { $r1receipt = "Rechnung an die Firmenadresse, nach dem Abendessen";  };
                          ...
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                ...
                                '.date("Y-m-d").'<br />
                                <br />
                                <span class="header-sm">Ihre Wunschtermine:</span> <br />
                                <b>'. date_format( date_create($data->ReservationDate), 'Y-m-d H:i').'</b><br>
                                <i>'. date_format( date_create($data->ReservationDate1), 'Y-m-d H:i').'</i><br>
                                <i>'. date_format( date_create($data->ReservationDate2), 'Y-m-d H:i').'</i><br>
                                <i>'. date_format( date_create($data->ReservationDate3), 'Y-m-d H:i').'</i><br>
                                <br />
...
try {
    ...
    foreach($configs->email->addressesTrafohotel as $e){
      ...
      //Recipients
      $mail2->setFrom($configs->email->adress, 'Fondue Chalet Baden');
    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
              Fondue Chalet reservation request!
            </td>
          </tr>
          <tr>
            <td class="w320">
